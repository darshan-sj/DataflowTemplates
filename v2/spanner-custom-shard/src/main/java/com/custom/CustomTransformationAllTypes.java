...
public class CustomTransformationAllTypes implements ISpannerMigrationTransformer {

  private static final Logger LOG = LoggerFactory.getLogger(CustomTransformationAllTypes.class);
